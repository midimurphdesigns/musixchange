...
export default class Ads extends React.Component {
  ...
  render() {
    if (this.state.error) {
      // change that for more personnal error
            ...
            <div className="ads-container" key={String(index)}>
              <div className="instrument-details">
                ...
                <div className="instrument-about">
                  <label className="ad-title">{element.title}</label>

                  <label className="instrument-type">
                  ...
                  <label className="instrument-description">
                    {element.description}
                  </label>

                  <label className="instrument-condition">
                    {element.condition}
                  </label>
